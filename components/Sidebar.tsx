...
const copy = {
  es: {
    ...
    pitch: '¿Tienes una idea? Hagámosla realidad',
    links: [
    ...
    socials: [
      ...
      { label: 'LinkedIn', href: 'https://www.linkedin.com/in/sebastian-lopez-alvarez-41b199185/' },
      { label: 'Correo', href: 'mailto:sebaslopez3025@gmail.com' },
  ...
  en: {
    ...
    role: 'AI Product Builder',
    available: 'Available',
    pitch: 'Have an idea? Let’s make it real',
    links: [
      { icon: '🏠', label: 'Home', href: '#top' },
      { icon: '📊', label: 'Dashboard', href: '#dashboard' },
      { icon: '🧭', label: 'Methodology', href: '#methodology' },
      { icon: '🤖', label: 'AI & Workflow', href: '#ai' },
    ...
    socials: [
      { label: 'GitHub', href: 'https://github.com/sebas-rgb' },
      { label: 'LinkedIn', href: 'https://www.linkedin.com/in/sebastian-lopez-alvarez-41b199185/' },
      { label: 'Email', href: 'mailto:sebaslopez3025@gmail.com' },
      { label: 'WhatsApp', href: 'https://wa.me/573225162352' }
    ]
  }
}
      ...
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <button
            ...
            className="rounded-full border border-white/10 bg-[#0d1320]/90 px-3 py-2 text-xs text-muted transition hover:bg-white/5 sm:hidden"
          >
            {t.close}
          </button>
        </div>
        ...
        <div className="mt-8 rounded-[1.75rem] border border-white/10 bg-[#091525]/90 p-5 text-sm text-muted shadow-glow">
          <p className="text-xs uppercase tracking-[0.28em] text-cyan-200/70">{t.available}</p>
          <p className="mt-3 text-sm font-semibold text-text">{t.pitch}</p>
        </div>
