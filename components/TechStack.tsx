...
const stack: StackGroup[] = [
  ...
  {
    category: 'IA',
    items: ['OpenAI', 'Codex', 'Claude', 'Prompt Engineering', 'AI Workflows'],
    accent: 'pink'
  }
]
    ...
    <section className="mt-20 rounded-[2rem] border border-white/10 bg-[#08111d]/90 p-8 shadow-soft">
      <div className="space-y-6">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.28em] text-cyan-300/80">Stack tecnológico</p>
            <h2 className="section-title font-semibold text-text">Tecnologías estilo estudio</h2>
          </div>
          <p className="max-w-2xl text-sm leading-7 text-muted sm:text-base">
            Un arsenal creativo de herramientas y plataformas presentado como tarjetas de exhibición.
          </p>
        </div>
